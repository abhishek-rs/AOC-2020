...
const day19A = require('./Day19A');
const day19B = require('./Day19B');
const day20A = require('./Day20A');
const day20B = require('./Day20B');
const day21A = require('./Day21A');
const day21B = require('./Day21B');
const day22A = require('./Day22A');
const day22B = require('./Day22B');
const day23A = require('./Day23A');
const day23B = require('./Day23B');
const day24A = require('./Day24A');
const day24B = require('./Day24B');
const day25A = require('./Day25A');
const day25B = require('./Day25B');
...
(async () => {
  const selection = await prompts({
    ...
    choices: [
      ...
      { title: 'Day 19 - A', value: day19A },
      { title: 'Day 19 - B', value: day19B },
      { title: 'Day 20 - A', value: day20A },
      { title: 'Day 20 - B', value: day20B },
      { title: 'Day 21 - A', value: day21A },
      { title: 'Day 21 - B', value: day21B },
      { title: 'Day 22 - A', value: day22A },
      { title: 'Day 22 - B', value: day22B },
      { title: 'Day 24 - A', value: day24A },
      { title: 'Day 24 - B', value: day24B },
      { title: 'Day 25 - A', value: day25A },
    ],
  });
